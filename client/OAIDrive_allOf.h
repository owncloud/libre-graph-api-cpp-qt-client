...
#ifndef OAIDrive_allOf_H
#define OAIDrive_allOf_H
...
class OAIDrive_allOf : public OAIObject {
public:
    OAIDrive_allOf();
    OAIDrive_allOf(QString json);
    ~OAIDrive_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrive_allOf)

#endif // OAIDrive_allOf_H
